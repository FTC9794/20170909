...
/**
 * Created by ishaa on 5/1/2018.
 */

@TeleOp(name = "One Controller Wizard Teleop")
public class oneGamepadTeleopWizard extends LinearOpMode {
    ...
    public void liftStateMachine(){
        ...
        switch(liftState) {
            ...
            case MANUAL:
                ...
                if (gamepad1.left_trigger < ANALOG_PRESSED && gamepad1.right_trigger < ANALOG_PRESSED) {
                    liftState = glyphLiftStates.POSITION;

                    //Check if right trigger is pressed (to go up) and if the position of the lift is less than the upper limit
                } else if (gamepad1.right_trigger >= ANALOG_PRESSED && liftPosition < LIFT_UPPER_LIMIT) {
                ...
                } else if (gamepad1.left_trigger >= ANALOG_PRESSED && glyphLimit.getState()) {
    ...
    public void rotateStateMachine(){
        ...
        switch(rotateState){
            ...
            case STOPPED:
                ...
                if(gamepad1.x&&liftState!= glyphLiftStates.MANUAL){
