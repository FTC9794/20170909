...
/**
 * CustomJewelDetector class.
 *
 * <p>An OpenCV pipeline generated by GRIP.
 *
 * @author GRIP
 */
public class CustomJewelDetector extends OpenCVPipeline{
    ...
    private int blueContours;
    private int redContours;
    static {
    ...
    public Mat processFrame(Mat rgba, Mat gray) {
        ...
        double[] hslThreshold0Hue = {144, 180.0};
        double[] hslThreshold0Saturation = {120, 255.0};
        ...
        double filterContours0MinArea = 70000.0;
        ...
        double filterContours0MaxVertices = 100000.0;
        ...
        redContours = filterContours0Output.size();
        // Step HSL_Threshold1:
        Mat hslThreshold1Input = blurOutput;
        double[] hslThreshold1Hue = {75, 125};
        double[] hslThreshold1Saturation = {125, 255.0};
        ...
        double filterContours1MinArea = 70000.0;
        ...
        blueContours = filterContours1Output.size();
        return rgba;
    }
    public jewelColor getColor(){
        if(redContours==1&&blueContours==0){
            return jewelColor.RED;
        }else if(redContours==0&&blueContours==1){
            return jewelColor.BLUE;
        }else{
            return jewelColor.UNDEFINED;
        }
    }
